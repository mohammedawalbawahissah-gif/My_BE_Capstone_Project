...
class ReferralCreateAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {"error": "Invalid emergency or facility"},
        ...
        referral = Referral.objects.create(
            ...
            if emergency.created_by else None,
...
def home(request):
    ...
    context = {
        ...
        "emergencies": Emergency.objects.exclude(
            status="resolved"
        ).count(),
    }
...
def transport(request):
    ...
    return render(
        request,
        "transport.html",
        {"transports": Transport.objects.select_related("facility")},
    )
